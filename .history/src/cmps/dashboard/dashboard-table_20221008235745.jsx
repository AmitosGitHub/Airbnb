...
export const DashboardTableNewOrder = ({ selectedStay }) => {
  const dataUser = [
    {
      _id: selectedStay.reservation.user._id,
      fullname: selectedStay.reservation.user.fullname,
      price: selectedStay.reservation.price,
      dates: selectedStay.reservation.dates,
      username: '75091961',
      password: 'Margaux',
