...
import { CircularStatic } from '../details/circular-static'
...
export const ReserveDetails = ({ selectedStay, user }) => {
  ...
  const setReservation = () => {
    console.log('selectedStay, user:', selectedStay, user)
    stayService.setReservationStay(selectedStay, user, dates, getTotalPrice())
  }

  const doReserve = () => {
    setReservation()
    setIsOpenModalReserve(!isOpenModalReserve)
    setIsOpenCircularStatic(true)
    setTimeout(() => {
      setIsOpenCircularStatic(false)
      setTimeout(() => {
