...
console.log('selectedStay:',selectedStay)
    if(!selectedStay) return <section className="sweet-loading"><PulseLoader
                                 color="#99a8a4"
                                 margin={7}
                                 size={16}
                                />
      ...
      <section className="container-details-descreption-reserve">
          ...
          <div className="details-content-descreption">
             <div className="details-hosted">
                  <div className="details-hosted-by">
                         <h2>Entire place hosted by <span>{selectedStay.host.fullname}</span></h2>
                          <ul>
             ...
             <div className="air-cover">
                 <h1><span>air</span>cover</h1>
                     <p>Every booking includes free protection from Host cancellations, listing 
                    inaccuracies, and other issues like trouble checking in.
                     </p>
             </div>

             <div className="more-info">
                 <h3>Some info has been automatically translated. Show original language</h3>
                    <p>
                          For those who don't want to put a mortgage on overnight accommodation 
                             in the wild... this is not a bungalow, this is my shooting studio, but when I'm not 
                             teaching or shooting, you can stay in it for a modest price. Accommodation on
                              mattresses in one space full of windows to the beautiful and green nature.
                            Privacy, quiet, inspiring. Comptest amenities, kitchenette, outdoor shower and in 
                           simple style...
                     </p>
             </div>
         ...
         <div className="details-content-reserve">
            ...
            <div className="reserve-header-price">
               <h2>${selectedStay.price} <span>night</span></h2>
               <h3>⭑ 5.0 <span> {selectedStay.reviews.length} reviews</span></h3>
            </div>
